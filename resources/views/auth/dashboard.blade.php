                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-6 pe-1">
                                    <img src="{{ asset('assets/auth/images/dashboard/img_1.jpg') }}"
                                        class="mb-2 mw-100 w-100 rounded" alt="image">
                                    <img src="{{ asset('assets/auth/images/dashboard/img_4.jpg') }}"
                                        class="mw-100 w-100 rounded" alt="image">
                                </div>
                                <div class="col-6 ps-1">
                                    <img src="{{ asset('assets/auth/images/dashboard/img_2.jpg') }}"
                                        class="mb-2 mw-100 w-100 rounded" alt="image">
                                    <img src="{{ asset('assets/auth/images/dashboard/img_3.jpg') }}"
                                        class="mw-100 w-100 rounded" alt="image">
                                </div>
                            </div>
                            <div class="d-flex mt-5 align-items-top">
                                <img src="{{ asset('assets/auth/images/faces/face3.jpg') }}"
