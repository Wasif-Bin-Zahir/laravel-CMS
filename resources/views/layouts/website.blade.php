...
<body id="body">
    ...
    <script src="{{ asset('https://code.jquery.com/jquery-git.min.js') }}"></script>
    <!-- Bootstrap 3.1 -->
    ...
    <script src="{{ asset('http://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.11.1/jquery.validate.min.js') }}">
    </script>
